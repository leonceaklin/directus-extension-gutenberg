...
exports.__experimentalGetReusableBlockTitle = exports.__experimentalGetPatternsByBlockTypes = exports.__experimentalGetPatternTransformItems = exports.__experimentalGetParsedPattern = void 0;
exports.__experimentalIsBlockInterfaceHidden = __experimentalIsBlockInterfaceHidden;
exports.__unstableGetContentLockingParent = exports.__unstableGetClientIdsTree = exports.__unstableGetClientIdWithClientIdsTree = exports.__unstableGetBlockWithoutInnerBlocks = void 0;
...
exports.getLastInsertedBlockClientId = getLastInsertedBlockClientId;
...
const getBlocksByClientId = (0, _rememo.default)((state, clientIds) => (0, _lodash.map)(Array.isArray(clientIds) ? clientIds : [clientIds], clientId => getBlock(state, clientId)), (state, clientIds) => (0, _lodash.map)(Array.isArray(clientIds) ? clientIds : [clientIds], clientId => state.blocks.tree.get(clientId)));
/**
...
const getBlockParentsByBlockName = (0, _rememo.default)(function (state, clientId, blockName) {
  ...
  return (0, _lodash.map)((0, _lodash.map)(parents, id => ({
    id,
