...
import { MenuGroup, MenuItem, __experimentalConfirmDialog as ConfirmDialog } from '@wordpress/components';
...
export default function DeleteTemplate() {
  ...
  const onDelete = () => {
    ...
    const newAvailableTemplates = pickBy(settings.availableTemplates, (_title, id) => {
  ...
  return createElement(MenuGroup, {
    ...
    info: isRevertable ? __('Use the template as supplied by the theme.') : undefined
  }, isRevertable ? __('Clear customizations') : __('Delete template')), createElement(ConfirmDialog, {
  ...
  __('Are you sure you want to delete the %s template? It may be used by other pages or posts.'), templateTitle))));
}
