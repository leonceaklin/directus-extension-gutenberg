...
import { EXTENSION_NAME_REGEX, EXTENSION_PKG_KEY, HYBRID_EXTENSION_TYPES, NESTED_EXTENSION_TYPES, } from '../../constants';
import { pluralize } from '../pluralize';
import { isIn, isTypeIn } from '../array-helpers';
export async function resolvePackageExtensions(root, extensionNames) {
    const extensions = [];
...
export async function getPackageExtensions(root) {
    var _a;
    let pkg;
    try {
...
export async function getLocalExtensions(root) {
    const extensions = [];
