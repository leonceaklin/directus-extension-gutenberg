...
function I18nProvider(props) {
  ...
  const [update, forceUpdate] = (0, _element.useReducer)(() => [], []); // Rerender translations whenever the i18n instance fires a change event.
...
function withI18n(InnerComponent) {
  const EnhancedComponent = props => {
    ...
    return (0, _element.createElement)(InnerComponent, (0, _extends2.default)({}, props, i18nProps));
  };
