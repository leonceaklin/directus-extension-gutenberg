...
.block-editor-block-list__block.has-block-overlay.is-reusable:hover:not(.is-dragging-blocks)::before, .block-editor-block-list__block.has-block-overlay.wp-block-template-part:hover:not(.is-dragging-blocks)::before {
