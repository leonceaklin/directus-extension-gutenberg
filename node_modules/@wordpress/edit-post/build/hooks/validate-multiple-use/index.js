...
const withMultipleValidation = (0, _compose.createHigherOrderComponent)(BlockEdit => {
  return enhance(_ref3 => {
    ...
    }, (0, _element.createElement)("strong", null, blockType === null || blockType === void 0 ? void 0 : blockType.title, ": "), (0, _i18n.__)('This block can only be used once.'))];
  });
...
function getOutboundType(blockName) {
  ...
  const transform = (0, _blocks.findTransform)((0, _blocks.getBlockTransforms)('to', blockName), _ref4 => {
    let {
      type,
      blocks
    } = _ref4;
