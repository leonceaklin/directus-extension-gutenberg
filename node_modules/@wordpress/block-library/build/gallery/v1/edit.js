...
function GalleryEdit(props) {
  ...
  function setAttributes(newAttrs) {
    ...
    if (newAttrs.images) {
      newAttrs = { ...newAttrs,
        ...
        ids: (0, _lodash.map)(newAttrs.images, _ref => {
          let {
            id
          } = _ref;
  ...
  function getImagesSizeOptions() {
    ...
    return (0, _lodash.map)(imageSizes.filter(_ref4 => {
      let {
        slug
      } = _ref4;
  ...
  function updateImagesSize(newSizeSlug) {
    const updatedImages = (0, _lodash.map)(images, image => {
      if (!image.id) {
        return image;
      }

      const url = (0, _lodash.get)(resizedImages, [parseInt(image.id, 10), newSizeSlug]);
      return { ...image,
        ...(url && {
          url
        })
  ...
  (0, _element.useEffect)(() => {
    if (_element.Platform.OS === 'web' && images && images.length > 0 && images.every(_ref6 => {
      ...
      const filesList = (0, _lodash.map)(images, _ref7 => {
        let {
          url
        } = _ref7;
