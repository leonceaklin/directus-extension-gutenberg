...
import { __experimentalTreeGridCell as TreeGridCell, __experimentalTreeGridItem as TreeGridItem, MenuItem } from '@wordpress/components';
...
function ListViewBlock(_ref) {
  ...
  const listViewBlockEditClassName = classnames('block-editor-list-view-block__menu-cell', {
    'is-visible': isHovered || isFirstSelectedBlock
  });
  let colSpan;
  ...
  }))), showBlockActions && createElement(Fragment, null, isEditable && createElement(TreeGridCell, {
    className: listViewBlockEditClassName,
    "aria-selected": !!isSelected || forceSelectionContentLock
  }, props => createElement(BlockEditButton, _extends({}, props, {
    label: editAriaLabel,
    clientId: clientId
  }))), createElement(TreeGridCell, {
      ...
      return createElement(MenuItem, {
        onClick: () => {
          ...
          if (block.name === 'core/navigation-submenu') {
            ...
            const newSubmenu = createBlock('core/navigation-submenu', block.attributes, block.innerBlocks ? [...block.innerBlocks, newLink] : [newLink]);
