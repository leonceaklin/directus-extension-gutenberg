...
exports.parseFilterFunctionPath = void 0;
...
function parseFilterFunctionPath(path) {
    if (path.includes('(') && path.includes(')')) {
        ...
        const matched = path.match(constants_1.REGEX_BETWEEN_PARENS);
        if (matched) {
...
exports.parseFilterFunctionPath = parseFilterFunctionPath;
