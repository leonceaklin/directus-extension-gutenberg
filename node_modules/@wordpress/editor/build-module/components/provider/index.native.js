...
class NativeEditorProvider extends Component {
  ...
  componentDidMount() {
    ...
    this.subscriptionParentUpdateEditorSettings = subscribeUpdateEditorSettings(_ref => {
      let {
  ...
  render() {
    ...
    return createElement(Fragment, null, createElement(EditorProvider, _extends({
      post: this.post,
      settings: editorSettings
    }, props), createElement(SafeAreaProvider, null, children)), createElement(EditorHelpTopics, {
