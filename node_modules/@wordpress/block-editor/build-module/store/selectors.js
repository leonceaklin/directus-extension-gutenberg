...
export const getBlocksByClientId = createSelector((state, clientIds) => map(Array.isArray(clientIds) ? clientIds : [clientIds], clientId => getBlock(state, clientId)), (state, clientIds) => map(Array.isArray(clientIds) ? clientIds : [clientIds], clientId => state.blocks.tree.get(clientId)));
/**
