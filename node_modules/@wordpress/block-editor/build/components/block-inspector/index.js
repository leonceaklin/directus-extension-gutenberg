...
const BlockInspector = _ref5 => {
  ...
  const blockInspectorAnimationSettings = (0, _data.useSelect)(select => {
    if (isOffCanvasNavigationEditorEnabled) {
      const globalBlockInspectorAnimationSettings = select(_store.store).getSettings().__experimentalBlockInspectorAnimation;
  ...
  return (0, _element.createElement)(BlockInspectorSingleBlockWrapper, {
    animate: isOffCanvasNavigationEditorEnabled && blockInspectorAnimationSettings,
...
const BlockInspectorSingleBlock = _ref8 => {
  ...
  return (0, _element.createElement)("div", {
  ...
  }), showTabs && (0, _element.createElement)(_inspectorControlsTabs.default, {
    ...
    __experimentalGroup: "border",
    label: (0, _i18n.__)('Border')
  }), (0, _element.createElement)("div", null, (0, _element.createElement)(_advancedControlsPanel.default, null))), (0, _element.createElement)(_skipToSelectedBlock.default, {
    key: "back"
  }));
};
/**
